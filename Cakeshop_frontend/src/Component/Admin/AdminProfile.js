...
function AdminProfile() {
    ...
    const init = () => {
        ...
        adminServices.getSpecificUserDetails(object.userId)
        .then(response => {
    ...
    const updateUser = () => {
        if (userId === "" || email === "" || password === "" || fname === "" || lname === "" || mobileNo === "" || city === "" || admin === "") {
            console.log("Empty")
        ...
        const data = { userId, email, password, fname, lname, mobileNo, city, admin }
                        ...
                        <div className="col-xl-8 col-md-8 col-12 col-sm-12">
                            ...
                            <div className="card shadow-lg mt-5">
                                <div className="card-body px-5 pt-5">
                                    <h1 className="fs-4 card-title fw-bold mb-4 text-center text-primary">Admin Profile</h1><hr/>
                                    ...
                                    <div className="row g-3">
                                        <div className="col mb-3">
                                            ...
                                            <input id="firstname" type="text" className="form-control" name="firstname" required
                                                value={fname} disabled={isDisabled}
                                        ...
                                        <div className="col mb-3">
                                            ...
                                            <input id="lastname" type="text" className="form-control" name="lastname" required
                                                value={lname} disabled={isDisabled}
                                    ...
                                    <div className="row g-3">
                                        <div className="col mb-3">
                                            ...
                                            <input id="phone" type="tel" className="form-control" name="phone" required
                                                pattern="[0-9]{10}"
                                                value={mobileNo} disabled={isDisabled}
                                                onChange={(e) => setMobileNo(e.target.value)}
                                            />
                                        </div>
                                        <div className="col mb-3">
                                            <label className="mb-2 text-muted" htmlFor="Address">Address</label>
                                            <input id="city" type="test" className="form-control" name="Address" required
